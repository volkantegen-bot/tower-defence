...
const ENEMY_DEFS = {
    ...
    saboteur: { name: 'Saboteur', baseHP: 120, speed: 25, baseDmg: 5, rankXP: 2, color: '#ff8a80', size: 7,
                canShoot: true, shootRange: 90, shootDamage: 25, shootRate: 2.0, targetsTowersOnly: true }
};
